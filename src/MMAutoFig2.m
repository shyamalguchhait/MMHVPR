...
UIFigure = uifigure('Visible', 'off', 'HandleVisibility', 'off');
...
startButton.FontSize = 24;
startButton.FontWeight = 'bold';
startButton.Position = [43 692 159 39];
startButton.Text = 'start';

% Create stopButton
stopButton = uibutton(UIFigure, 'push', 'ButtonPushedFcn',@(stopButton,event) stop);
stopButton.FontSize = 24;
stopButton.FontWeight = 'bold';
stopButton.Position = [293 692 159 39];
